  ...
  return (
    <Layout>
      <PageHeader
        ...
        body="End-to-end Implementation of ISO 27001, NDPR, and PCIDSS Controls To Unblock Enterprise Deals And Regulatory Licences."
      />
...
export default ComplianceReady;
